...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    //Note: also IndexWriter::commit() doesn't block and program will exit without writting anything

    let _ = full_page_text_history_search::index_management::test_index(index_values.unwrap());
